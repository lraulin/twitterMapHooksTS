  ...
  render() {
    ...
    if (w > 1000) {
      if (h > 650) {
        ...
        imgStyle.width = `${(media.sizes.large.w / media.sizes.large.h) *
          650}px`;
        modalWrap.width = imgStyle.width;
      } else {
        modalWrap.width = `${(media.sizes.large.w / media.sizes.large.h) *
          650}px`;
        imgStyle.height = `${(media.sizes.large.h / media.sizes.large.w) *
          1000}px`;
      }
    } else {
      if (h > 650) {
